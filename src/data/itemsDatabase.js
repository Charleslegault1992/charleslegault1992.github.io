...
export const itemsDatabase = {
  ...
  frogCorpse: {
    ...
    capacity: 5,
    decayType: "monster",
    render: { atlas: "items", parts: [{ atlasCol: 12, atlasRow: 3, offsetX: 0, offsetY: 0, zOffset: 0 }] },
  },
  playerCorpse: {
    itemId: "playerCorpse",
    name: "Player Corpse",
  ...
  fireFieldRune: {
    ...
    stackable: false,
    blockMovement: false,
    use: { mode: "target", action: "createField", groundEffectId: "fireField", charges: 5, range: 7, cooldownGroup: "rune" },
