...
export const GAME_CONTENT_TEXT = {
  fr: {
    items: {
      ...
      chickenLeg: { name: "Cuisse de poulet", pluralName: "Cuisses de poulet", desc: "Une cuisse de poulet rotie.", suffix: "une" },
      ...
      raidChest: { name: "Coffre de raid", pluralName: "Coffres de raid", desc: "Un coffre contenant les recompenses d'un raid termine.", suffix: "un" },
      ...
      frogCorpse: { name: "Cadavre de grenouille", pluralName: "Cadavres de grenouille", desc: "Une grenouille morte.", suffix: "un" },
      scorpionCorpse: { name: "Cadavre de scorpion", pluralName: "Cadavres de scorpion", desc: "Un scorpion mort.", suffix: "un" },
      ...
      shortSword: { name: "Epee courte", pluralName: "Epees courtes", desc: "Une epee courte, legere et bien equilibree.", suffix: "une" },
      ...
      wildBoarCorpse: { name: "Cadavre de sanglier", pluralName: "Cadavres de sanglier", desc: "Un sanglier mort.", suffix: "un" },
