...
export const GAME_UI_TEXT = {
  en: {
    ...
    invalidCredentials: "Invalid account name or password.",
    ...
    pvpEnabled: "PVP enabled. Only other PVP players can attack you.",
    ...
    pvpRequiresBothPlayers: "Both players must enable PVP.",
    youDied: "You died.",
  ...
  fr: {
    ...
    invalidCredentials: "Le nom du compte ou le mot de passe est invalide.",
    ...
    pvpEnabled: "PVP active. Seuls les autres joueurs PVP peuvent t'attaquer.",
    ...
    pvpRequiresBothPlayers: "Les deux joueurs doivent activer le PVP.",
    youDied: "Tu es mort.",
